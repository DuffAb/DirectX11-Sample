  ...
  mTheta(1.3f*MathHelper::Pi), mPhi(0.4f*MathHelper::Pi), mRadius(80.0f)
{
	...
	XMMATRIX boxScale = XMMatrixScaling(15.0f, 15.0f, 15.0f);// Ëõ·Å
	XMMATRIX boxOffset = XMMatrixTranslation(8.0f, 5.0f, -15.0f);//Î»ÒÆ
...
bool BlendApp::Init()
{
	...
	HR(CreateDDSTextureFromFile(md3dDevice,	L"Textures/grass.dds", 0, &mGrassMapSRV, 0, 0));
	HR(CreateDDSTextureFromFile(md3dDevice,	L"Textures/water2.dds", 0, &mWavesMapSRV, 0, 0));
	HR(CreateDDSTextureFromFile(md3dDevice,	L"Textures/WireFence.dds", 0, &mBoxMapSRV, 0, 0));
